...
public interface TimetableService {
    ...
    void exportGeneratedTimetable(List<Timetable> generatedTimetables, Shift shift, HashMap<String, Integer> iterationsToAchieveBestValue, int semester) throws IOException;
}
